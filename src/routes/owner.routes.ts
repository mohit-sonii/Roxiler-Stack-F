...
router.route("/:id/reset-pass").post(middleware,updatePassword) // this is taken from user as eventullay the owner is in user though and there logic was similar
